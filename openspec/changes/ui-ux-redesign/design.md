...
- Top 35% of screen: `Container` with navy gradient, centred SVG logo + "XCaro" wordmark + tagline "Cờ Gomoku Online".
...
- AppBar retains: title "XCaro", theme toggle (right), help icon (right).
